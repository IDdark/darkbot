...
cl = LINETCR.LINE()
cl.login(token="EpPmuU3apgsNsrMYD8p5.0t+Y8cxMBWUD5ZIU84Dkvq.721+hyJviYsP8DrAIZG2aCjvmZiE+CoDH2gRDNXr5yk=")
cl.loginResult()
...
helpMessage="""(╚••I̥̩̥̽D̥̩̥̽d̥̩̥̽ḁ̩̥̽r̥̩̥̽k̥̩̥̽ ̰в̰̰̈́❍̰̰̈́т̰̰̈́ѕ̰̰̈́••╝)
  ...
  ★ Proinvite:on/off
  ★ Procancel:on/off
     Admin: http://line.me/ti/p/~7xcrazy
http://line.me/ti/p/~mr.51mpl3

(╚••I̥̩̥̽D̥̩̥̽d̥̩̥̽ḁ̩̥̽r̥̩̥̽k̥̩̥̽  ̰в̰̰̈́❍̰̰̈́т̰̰̈́ѕ̰̰̈́••╝)
"""
...
Bots=[mid]
admsa ="ud13ff2f025e66f0b9de738aef3874a55"
...
#                if msg.from_ in admin:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ud13ff2f025e66f0b9de738aef3874a55'}
                cl.sendMessage(msg)
            elif "Mymid" == msg.text:
